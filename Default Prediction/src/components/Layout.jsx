        ...
        <div className="flex flex-col w-64 bg-gradient-to-b from-blue-800 to-blue-900 text-white">
          <div className="flex items-center justify-center h-16 px-4 border-b border-blue-700">
            <div className="flex items-center">
              <i className="fas fa-chart-line text-2xl text-blue-300 mr-2"></i>
              <span className="text-xl font-semibold">RiskAnalyzer</span>
            </div>
          </div>
          <div className="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
            <nav className="flex-1 space-y-2">
              <Link to="/" className="flex items-center px-4 py-3 text-sm font-medium rounded-lg bg-blue-700 text-white">
                <i className="fas fa-home mr-3"></i>
                Dashboard
              </Link>
              <Link to="/analyze" className="flex items-center px-4 py-3 text-sm font-medium rounded-lg text-blue-200 hover:bg-blue-700 hover:text-white">
                <i className="fas fa-file-upload mr-3"></i>
                Analyze Data
              </Link>
              <Link to="/history" className="flex items-center px-4 py-3 text-sm font-medium rounded-lg text-blue-200 hover:bg-blue-700 hover:text-white">
